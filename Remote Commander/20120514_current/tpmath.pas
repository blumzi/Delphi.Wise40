...
procedure InitGen(Seed : RNG_IntType); external 'tpmath';
{ Initialize generator }

function IRanGen : RNG_IntType; external 'tpmath';
{ 32-bit random integer in [-2^31 .. 2^31 - 1] }

function IRanGen31 : RNG_IntType; external 'tpmath';
...
procedure InitUVAG(Seed : RNG_IntType); external 'tpmath';
{ Initializes the UVAG generator with an integer }

function IRanUVAG : RNG_IntType; external 'tpmath';
...
function Min(X : PVector; Lb, Ub : Integer) : Float; external 'tpmath';
{ Minimum of sample X }

function Max(X : PVector; Lb, Ub : Integer) : Float; external 'tpmath';
{ Maximum of sample X }
...
procedure AutoScale(X : PVector; Lb, Ub : Integer; Scale : TScale;
                    var XMin, XMax, XStep : Float); external 'tpmath';
...
procedure SVDPolFit(X, Y        : PVector;
                    Lb, Ub, Deg : Integer;
                    SVDTol      : Float;
                    B           : PVector;
                    V           : PMatrix); external 'tpmath';
...
procedure WSVDPolFit(X, Y, S     : PVector;
                     Lb, Ub, Deg : Integer;
                     SVDTol      : Float;
                     B           : PVector;
                     V           : PMatrix); external 'tpmath';
...
function GetOptAlgo : TOptAlgo; external 'tpmath';
...
procedure WFracFit(X, Y, S    : PVector;
                   Lb, Ub     : Integer;
                   Deg1, Deg2 : Integer;
                   ConsTerm   : Boolean;
                   MaxIter    : Integer;
...
function FracFit_Func(X : Float; B : PVector) : Float; external 'tpmath';
{ Returns the value of the rational fraction at point X }

procedure ExpFit(X, Y         : PVector;
                 Lb, Ub, Nexp : Integer;
                 ConsTerm     : Boolean;
                 MaxIter      : Integer;
                 Tol          : Float;
...
procedure WExpFit(X, Y, S      : PVector;
                  Lb, Ub, Nexp : Integer;
                  ConsTerm     : Boolean;
                  MaxIter      : Integer;
                  Tol          : Float;
...
function ExpFit_Func(X : Float; B : PVector) : Float; external 'tpmath';
{ Returns the value of the regression function at point X }

procedure IncExpFit(X, Y     : PVector;
                    Lb, Ub   : Integer;
                    ConsTerm : Boolean;
                    MaxIter  : Integer;
                    Tol      : Float;
...
procedure WIncExpFit(X, Y, S  : PVector;
                     Lb, Ub   : Integer;
                     ConsTerm : Boolean;
                     MaxIter  : Integer;
                     Tol      : Float;
...
function IncExpFit_Func(X : Float; B : PVector) : Float; external 'tpmath';
{ Returns the value of the regression function at point X }

procedure ExpLinFit(X, Y    : PVector;
                    Lb, Ub  : Integer;
                    MaxIter : Integer;
                    Tol     : Float;
                    B       : PVector;
...
procedure WExpLinFit(X, Y, S : PVector;
                     Lb, Ub  : Integer;
                     MaxIter : Integer;
                     Tol     : Float;
                     B       : PVector;
...
function ExpLinFit_Func(X : Float; B : PVector) : Float; external 'tpmath';
{ Returns the value of the regression function at point X }

procedure MichFit(X, Y    : PVector;
                  Lb, Ub  : Integer;
                  MaxIter : Integer;
                  Tol     : Float;
                  B       : PVector;
...
procedure WMichFit(X, Y, S : PVector;
                   Lb, Ub  : Integer;
                   MaxIter : Integer;
                   Tol     : Float;
                   B       : PVector;
...
function MichFit_Func(X : Float; B : PVector) : Float; external 'tpmath';
{ Returns the value of the Michaelis equation at point X }

procedure MintFit(X, Y    : PVector;
                  Lb, Ub  : Integer;
                  MaxIter : Integer;
                  Tol     : Float;
                  B       : PVector;
...
procedure WMintFit(X, Y, S : PVector;
                   Lb, Ub  : Integer;
                   MaxIter : Integer;
                   Tol     : Float;
                   B       : PVector;
...
function MintFit_Func(X : Float; B : PVector) : Float; external 'tpmath';
{ Returns the value of the integrated Michaelis equation at point X }

procedure HillFit(X, Y    : PVector;
                  Lb, Ub  : Integer;
                  MaxIter : Integer;
                  Tol     : Float;
                  B       : PVector;
...
procedure WHillFit(X, Y, S : PVector;
                   Lb, Ub  : Integer;
                   MaxIter : Integer;
                   Tol     : Float;
                   B       : PVector;
...
function HillFit_Func(X : Float; B : PVector) : Float; external 'tpmath';
{ Returns the value of the Hill equation at point X }

procedure LogiFit(X, Y     : PVector;
                  Lb, Ub   : Integer;
                  ConsTerm : Boolean;
                  General  : Boolean;
                  MaxIter  : Integer;
...
procedure WLogiFit(X, Y, S  : PVector;
                   Lb, Ub   : Integer;
                   ConsTerm : Boolean;
                   General  : Boolean;
                   MaxIter  : Integer;
...
function LogiFit_Func(X : Float; B : PVector) : Float; external 'tpmath';
{ Returns the value of the logistic function at point X }

procedure PKFit(X, Y    : PVector;
                Lb, Ub  : Integer;
                MaxIter : Integer;
                Tol     : Float;
                B       : PVector;
...
procedure WPKFit(X, Y, S : PVector;
                 Lb, Ub  : Integer;
                 MaxIter : Integer;
                 Tol     : Float;
                 B       : PVector;
...
function PKFit_Func(X : Float; B : PVector) : Float; external 'tpmath';
{ Returns the value of the acid-base titration function at point X }

procedure PowFit(X, Y    : PVector;
                 Lb, Ub  : Integer;
                 MaxIter : Integer;
                 Tol     : Float;
                 B       : PVector;
...
procedure WPowFit(X, Y, S : PVector;
                  Lb, Ub  : Integer;
                  MaxIter : Integer;
                  Tol     : Float;
                  B       : PVector;
...
function PowFit_Func(X : Float; B : PVector) : Float; external 'tpmath';
...
procedure SetGraphTitle(Title : String); external 'tpmath';
{ Sets the title for the graph }

procedure SetOxTitle(Title : String); external 'tpmath';
{ Sets the title for the Ox axis }

procedure SetOyTitle(Title : String); external 'tpmath';
...
procedure SetMaxCurv(NCurv : Byte); external 'tpmath';
...
procedure PlotPoint(Canvas    : TCanvas;
                    X, Y      : Float;
                    CurvIndex : Integer); external 'tpmath';
{$ELSE}
procedure PlotPoint(Xp, Yp, CurvIndex : Integer); external 'tpmath';
{$ENDIF}
...
function Xpixel(X : Float) : Integer; external 'tpmath';
{ Converts user abscissa X to screen coordinate }

function Ypixel(Y : Float) : Integer; external 'tpmath';
{ Converts user ordinate Y to screen coordinate }

function Xuser(X : Integer) : Float; external 'tpmath';
{ Converts screen coordinate X to user abscissa }

function Yuser(Y : Integer) : Float; external 'tpmath';
{ Converts screen coordinate Y to user ordinate }

procedure LeaveGraphics; external 'tpmath';
{ Quits graphic mode }
...
function TeX_InitGraphics(FileName          : String;
                          ...
                          Header            : Boolean) : Boolean; external 'tpmath';
{ Initializes the LaTeX file }

procedure TeX_SetWindow(X1, X2, Y1, Y2 : Integer; GraphBorder : Boolean); external 'tpmath';
{ Sets the graphic window }

procedure TeX_LeaveGraphics(Footer : Boolean); external 'tpmath';
{ Close the LaTeX file }

procedure TeX_SetOxScale(Scale : TScale; OxMin, OxMax, OxStep : Float); external 'tpmath';
{ Sets the scale on the Ox axis }

procedure TeX_SetOyScale(Scale : TScale; OyMin, OyMax, OyStep : Float); external 'tpmath';
{ Sets the scale on the Oy axis }

procedure TeX_SetGraphTitle(Title : String); external 'tpmath';
{ Sets the title for the graph }

procedure TeX_SetOxTitle(Title : String); external 'tpmath';
{ Sets the title for the Ox axis }

procedure TeX_SetOyTitle(Title : String); external 'tpmath';
{ Sets the title for the Oy axis }

procedure TeX_PlotOxAxis; external 'tpmath';
{ Plots the horizontal axis }

procedure TeX_PlotOyAxis; external 'tpmath';
{ Plots the vertical axis }

procedure TeX_PlotGrid(Grid : TGrid); external 'tpmath';
{ Plots a grid on the graph }

procedure TeX_WriteGraphTitle; external 'tpmath';
{ Writes the title of the graph }

procedure TeX_SetMaxCurv(NCurv : Byte); external 'tpmath';
{ Sets the maximum number of curves and re-initializes their parameters }

procedure TeX_SetPointParam(CurvIndex, Symbol, Size : Integer); external 'tpmath';
{ Sets the point parameters for curve # CurvIndex }

procedure TeX_SetLineParam(CurvIndex, Style : Integer;
                           Width : Float; Smooth : Boolean); external 'tpmath';
{ Sets the line parameters for curve # CurvIndex }

procedure TeX_SetCurvLegend(CurvIndex : Integer; Legend : String); external 'tpmath';
{ Sets the legend for curve # CurvIndex }

procedure TeX_SetCurvStep(CurvIndex, Step : Integer); external 'tpmath';
{ Sets the step for curve # CurvIndex }

procedure TeX_PlotCurve(X, Y : PVector; Lb, Ub, CurvIndex : Integer); external 'tpmath';
{ Plots a curve }

procedure TeX_PlotCurveWithErrorBars(X, Y, S : PVector;
                                     Ns, Lb, Ub, CurvIndex : Integer); external 'tpmath';
{ Plots a curve with error bars }

procedure TeX_PlotFunc(Func : TFunc; X1, X2 : Float;
                       Npt : Integer; CurvIndex : Integer); external 'tpmath';
{ Plots a function }

procedure TeX_WriteLegend(NCurv : Integer; ShowPoints, ShowLines : Boolean); external 'tpmath';
{ Writes the legends for the plotted curves }

procedure TeX_ConRec(Nx, Ny, Nc : Integer;
                     X, Y, Z    : PVector;
                     F          : PMatrix); external 'tpmath';
{ Contour plot }

function Xcm(X : Float) : Float; external 'tpmath';
{ Converts user coordinate X to cm }

function Ycm(Y : Float) : Float; external 'tpmath';
